...
const Item = ({ title, to, icon }) => {
  //create a function for holding the sidevar details
  return (
    <Link to={to}>
        ...
        <Sidebar collapsed={isCollapsed} style={ThemeStyles}>
          ...
          <Menu className="bg-gray-500">
            <Box paddingLeft={!isCollapsed ? undefined : "10%"}>
              ...
              <Box>
                <Item icon={<ContactPage />} title="Clients" to="/ClientList" />
              </Box>
              ...
              <Box>
                <Item icon={<SummarizeIcon />} title="Reports" to="/Reports" />
              </Box>
              <Box>
                <Item icon={<ReceiptIcon />} title="Invoice" to="/Invoice" />
              </Box>
              <Box>
                <Item

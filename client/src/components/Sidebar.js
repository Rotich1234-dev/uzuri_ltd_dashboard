...
// //     { name: "ClientList", icon: IoPeople },
// //     { name: "ServiceForm", icon: GrServices },
// //     { name: "FeeCalculator", icon: FaMoneyCheck },
// //     { name: "ReportGenerator", icon: HiOutlineDocumentReport },
// //     { name: "InvoiceGenerator", icon: FaFileInvoice },
// //     { name: "Email", icon: MdEmail },
// //     { name: "Help-Desk", icon: MdLogout },
// //     { name: "Calendar", icon: FaCalendar },
// //     { name: "Authentication", icon: SiAuthentik },
...
//         >
          {/* {navItems.map((item, index) => (
              <Link
                key={item.name} href={item.component}>
                  <div
                id="link-box"
                className={
                  "flex justify-start items-center gap-4 w-full cursor-pointer rounded-xl " +

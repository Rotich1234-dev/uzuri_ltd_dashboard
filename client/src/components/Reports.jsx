    ...
    const MyDocument = () => (
      <Document>
        <Page style={styles.page}>
          ...
          <Text style={styles.text}><strong>Description:</strong> {report.description}</Text>
          <Text style={styles.text}><strong>Date:</strong> {report.date}</Text>
          <Text style={styles.text}><strong>Format:</strong> {report.format}</Text>
        </Page>
      </Document>
    );
    ...
    <div className="pb-40 px-5 py-7 w-full h-screen overflow-y-auto" style={ThemeStyles}>
      <div className="max-w-3xl mx-auto bg-gray-400 shadow-md rounded-lg px-8 pt-6 pb-8 mb-4">
        ...
        <ul className="space-y-6">
          {reports.map((report) => (
            <li key={report.id} className="bg-gray-100 p-6 rounded-lg shadow-md">
              <h2 className="text-gray-900 text-xl font-semibold mb-2">{report.title}</h2>
              <p className="text-gray-900 mb-2">{report.description}</p>
              <p className="text-gray-900 mb-2"><strong>Date:</strong> {report.date}</p>
              <p className="text-gray-900 mb-4"><strong>Format:</strong> {report.format}</p>
              <button

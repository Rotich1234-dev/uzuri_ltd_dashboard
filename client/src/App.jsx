    ...
    <div className="app overflow-hidden" style={ThemeStyles}>
      ...
      <main className="content">
        ...
        <Routes>
          ...
          <Route
            path="/Profile"
            element={<Authentication ThemeStyles={ThemeStyles} />}
          />
          <Route path="/" element={<Dashboard ThemeStyles={ThemeStyles} />} />
          <Route path="/Calendar" element={<MyCalendar />} />
          <Route
            path="/FeeCalculator"
            element={<FeeCalculator ThemeStyles={ThemeStyles} />}
          />
          <Route path="/ServiceForm" element={<ServiceForm />} />
          <Route
            path="/Invoice"
            element={<Invoice ThemeStyles={ThemeStyles} />}
          />
          <Route path="/Reports" element={<Reports />} />
          <Route
            path="/OurChart"
            element={<OurChart ThemeStyles={ThemeStyles} />}
          />
